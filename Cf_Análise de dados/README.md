# Curso introdução à análise de dados Microsoft 

# Sobre o curso
Preparação dos Dados: Conexão a diferentes fontes de dados (arquivos locais, bancos de dados SQL, nuvem), limpeza de inconsistências e transformações iniciais utilizando o Power Query.
